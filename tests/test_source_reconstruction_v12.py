...
class SourceReconstructionV12Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.tracker = json.loads((ROOT / "registry/trackers/all_progress_tracker_reconciliation_v12.json").read_text())
    ...
    def test_tracker_preserves_v11(self): self.assertIn("v11", self.tracker["preservation_rule"])
