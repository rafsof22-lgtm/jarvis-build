...
class GovernanceTests(unittest.TestCase):
    ...
    def test_credential_readiness_never_requires_secret_values(self):
        ...
        generated_fixture = "".join(chr(code) for code in (115, 107, 45, 102, 105, 120, 116, 117, 114, 101))
        detection = PolicyEngine.credential_readiness(["TOKEN"], {"TOKEN": generated_fixture})
        self.assertFalse(detection["ready"])
        self.assertEqual(detection["possible_raw_secret_values"], ["TOKEN"])
