...
class GovernanceTests(unittest.TestCase):
    ...
    def test_credential_readiness_uses_references_and_reports_missing(self):
        ready = PolicyEngine.credential_readiness(["DB_SECRET_REF"], {"DB_SECRET_REF": "vault://db/main"})
        self.assertTrue(ready["ready"])
        missing = PolicyEngine.credential_readiness(["MODEL_CREDENTIAL_REF"], {})
        self.assertFalse(missing["ready"])
        self.assertEqual(missing["missing_references"], ["MODEL_CREDENTIAL_REF"])
